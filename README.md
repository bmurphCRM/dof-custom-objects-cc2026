...
Custom Salesforce objects for the **Department of Future (DOF)** built as part of the CC2026 project. This SFDX project contains 4 custom objects designed to manage core government finance operations including licensing, taxation, utility billing, and vital records.
